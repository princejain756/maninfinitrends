	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'pulse-glow': {
					'0%, 100%': { boxShadow: '0 0 5px hsl(var(--mnf-gold) / 0.5)' },
					'50%': { boxShadow: '0 0 20px hsl(var(--mnf-gold) / 0.8), 0 0 30px hsl(var(--mnf-gold) / 0.3)' }
				}
			},
			animation: {
				'accordion-down': 'accordion-down 0.2s ease-out',
				'accordion-up': 'accordion-up 0.2s ease-out',
				'silk-wave': 'silk-wave 6s ease-in-out infinite',
